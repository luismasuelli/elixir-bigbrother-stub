defmodule BigBrother.Storage.Main.Models.User do
  ...
  def register(%{} = data, opts) do
    [admin, hash_alg] = BigBrother.Utils.Misc.get_keywords([admin: false, hash_alg: nil])
    ...
    |> Ecto.Changeset.validate_confirmation(:password, true, message: "must match confirmation")
